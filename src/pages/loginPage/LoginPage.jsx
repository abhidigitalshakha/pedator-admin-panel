...
const LoginPage = () => {
  ...
  return (
    <div className="h-screen w-screen flex flex-col items-center justify-center gap-8 bg-[#effffe]">
        <AnimatedHeading texts={["Welcome to the Admin Panel!","Manage Your Platform Easily!"]}/>
      <div className="grid grid-cols-1 lg:grid-cols-2 place-content-center w-full">
        ...
        <div className="flex flex-col justify-center items-center">
          <div className=" p-8 rounded-lg border border-gray-300 ">
            <p className="text-center text-gray-600 mb-8 font-[500] text-3xl">
            ...
            <form onSubmit={handleSubmit} className="min-w-[350px]">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <a href="#" className="text-sm text-[#108e88] hover:underline">
                  Forgot password?
                </a>
              </div>
              <button
