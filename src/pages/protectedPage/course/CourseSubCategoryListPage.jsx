...
import { useCourseSubCategories } from "../../../hooks/useCourseCategories";
import { courseSubCategoryColumns } from "../../../constants/global.constant";
import PediatorLoader from "../../../components/PediatorLoader";

const CourseSubCategory = () => {
  const { data: courseSubCategory, status, error } = useCourseSubCategories();
  ...
  return (
    <div className="bg-white p-4 rounded-md flex-1 m-4 border border-gray-300 shadow-xl">
      ...
      <Table
        columns={courseSubCategoryColumns}
        renderRow={renderRow}
